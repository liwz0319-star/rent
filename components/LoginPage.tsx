...
const LoginPage: React.FC<LoginPageProps> = ({ onNavigateToSignup, onLoginSuccess }) => {
  ...
  const handleSocialLogin = (provider: string) => {
    // alert(`Initiating ${provider} login flow...`);
  ...
  return (
    <div className="h-screen w-full bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark font-sans antialiased overflow-hidden flex">
      {/* Left Column - Image & Branding (Reverted to Original Blue Sky) */}
      <div className="hidden lg:flex w-1/2 relative bg-sky-400">
        <img
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-16 bg-background-light dark:bg-background-dark overflow-y-auto">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-500 dark:text-gray-400">Please enter your credentials to access the dashboard.</p>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded dark:bg-surface-dark dark:border-gray-600 cursor-pointer"
                />
                <label className="ml-2 block text-sm text-gray-700 dark:text-gray-300 cursor-pointer" htmlFor="remember-me">
                  Remember me
                </label>
              </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button
              ...
              className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-surface-dark text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-400"
            >
